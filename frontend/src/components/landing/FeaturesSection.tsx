...
import { fadeUp, slideFromLeft, slideFromRight, staggerContainer, floatAnimation } from "./animations";
...
export default function FeaturesSection() {
  return (
    <section className="snap-start min-h-screen flex items-center justify-center px-6 py-20 relative overflow-hidden">
      {/* Floating envelopes */}
      <motion.div animate={floatAnimation} transition={{ ...floatAnimation.transition, duration: 5.2, delay: 0.5 }} className="absolute pointer-events-none" style={{ top: "8%", left: "6%", rotate: 12 }}>
        <EnvelopeSVG size={38} />
      </motion.div>
      <motion.div animate={floatAnimation} transition={{ ...floatAnimation.transition, duration: 5.6, delay: 1.4 }} className="absolute pointer-events-none" style={{ top: "14%", left: "86%", rotate: -20 }}>
        <EnvelopeSVG size={32} />
      </motion.div>
      <motion.div animate={floatAnimation} transition={{ ...floatAnimation.transition, duration: 4.8, delay: 2.2 }} className="absolute pointer-events-none" style={{ top: "72%", left: "4%", rotate: -8 }}>
        <EnvelopeSVG size={34} />
      </motion.div>
      <motion.div animate={floatAnimation} transition={{ ...floatAnimation.transition, duration: 6.0, delay: 0.9 }} className="absolute pointer-events-none" style={{ top: "68%", left: "89%", rotate: 18 }}>
        <EnvelopeSVG size={40} />
      </motion.div>
      <motion.div animate={floatAnimation} transition={{ ...floatAnimation.transition, duration: 5.0, delay: 1.8 }} className="absolute pointer-events-none" style={{ top: "42%", left: "92%", rotate: -15 }}>
        <EnvelopeSVG size={28} />
      </motion.div>
